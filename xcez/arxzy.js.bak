...
module.exports = arxzy = async (arxzy, m, msg, chatUpdate, store) => {
    try {
        ...
        const sticker = []
        const isAdrian = ('6285692195658@s.whatsapp.net').includes(m.sender)
        /* ~~~~~~~~~ GROUP SYSTEM ~~~~~~~~~ */
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
        ...
        switch (isCommand) {
            ...
            case 'setimgmenu':
            case 'sim': {
                if (!isitsuka) return newReply(mess.owner)
                let delb = await arxzy.downloadAndSaveMediaMessage(quoted)
            ...
            case 'addcase': {
               ...
               let indexSwitchCommand = code.indexOf('// Created By itsukaBotz');
...
`.trim()
                    ...
                    if (stdout.trim()) arxzy.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                title: 'SPEED TEST',
                                body: `FORGET DONATE`,
                                thumbnailUrl: 'https://telegra.ph/file/d63e00fd5461d61f37c28.jpg',
                                sourceUrl: global.link,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
            ...
            case 'script':
            case 'scriptbot':
                uy = `https://youtube.com/itsukabotz`
                arxzy.sendMessage(m.chat, {
                    text: uy,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: 'Script Free',
                            body: `SCRIPT BOT ${namabot} Ada Di Youtube @itsukabotz`,
...
let menunya = `ʜᴀʟʟᴏ ᴋᴀᴋ 👋 ${pushname}\nᴘᴇʀᴋᴇɴᴀʟᴋᴀɴ sᴀʏᴀ itsukaBotz, sᴀʏᴀ ᴅɪsɪɴɪ sᴇʙᴀɢᴀɪ ʀᴏʙᴏᴛ ᴀᴛᴀᴜ ᴀɪ ʏᴀɴɢ ᴍᴇᴍʙᴀɴᴛᴜ ʜᴀʟ-ʜᴀʟ ᴛᴇʀᴛᴇɴᴛᴜ\n
*ᴅᴀᴛᴇ/ᴛɪᴍᴇ:*\n[ *${hariini} / ${wib}* ]
*sᴇʀɪᴀʟᴄᴏᴅᴇ:*\n[ *${a.serialNumber}* ]
*ʟɪᴍɪᴛ:* ${a.limit}
